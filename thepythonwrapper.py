...
os.system("mv SRR1278956.sra HM27.sra")
os.system("mv SRR1278960.sra HM46.sra")
os.system("mv SRR1283106.sra HM65.sra")
os.system("mv SRR1278963.sra HM69.sra")
...
os.system("mv HM27/*.gff HM27.gff")
os.system("mv HM46/*.gff HM46.gff")
os.system("mv HM65/*.gff HM65.gff")
os.system("mv HM69/*.gff HM69.gff")
os.system("bowtie-build HM27.gff HM27")
os.system("bowtie-build HM46.gff HM46")
os.system("bowtie-build HM65.gff HM65")
os.system("bowtie-build HM69.gff HM69")
os.system("tophat2 -p 4 -o HM27 HM27 HM27_1.fastq HM27_2.fastq")
os.system("tophat2 -p 4 -o HM46 HM46 HM46_1.fastq HM46_2.fastq")
os.system("tophat2 -p 4 -o HM65 HM65 HM65_1.fastq HM65_2.fastq")
os.system("tophat2 -p 4 -o HM69 HM69 HM69_1.fastq HM69_2.fastq")
